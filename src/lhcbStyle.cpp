...
void lhcb::lhcbStyle() {
  ...
  // lhcbStyle->SetOptFit(1011); // order is probability, Chi2, errors,
  // parameters
  // titles
  ...
  //		// text font
  //		int font = 132;
  //		gStyle->SetTitleFont(font, "xyz");	// set the all 3 axes title
  //font
  //		gStyle->SetTitleFont(font, " ");	// set the pad title
  //font
  ...
  //
  //		// set the paper & margin sizes Changed the values to look a bit
  // nicer TOBI 20120823 does not work properly yet
